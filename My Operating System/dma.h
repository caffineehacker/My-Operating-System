...
/* NOTES **************
 * DMA1 is a 16-bit master DMA
 * DMA0 is an 8-bit slave DMA
 *
 * DMA only works on physical addresses even if paging is enabled
 */
...
/* Memory address registers for DMA0 */
enum DMA0_PAGE_REG
{
...
/* Command register mask.  Only Enable is supported on x86 */
